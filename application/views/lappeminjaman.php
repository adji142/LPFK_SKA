	...
	function bindGrid(data) {
		...
		$("#gridContainer").dxDataGrid({
	        ...
	        columns: [
	            ...
	            {
	                dataField: "kodefasyankes",
	                caption: "Kode Fasyankes",
	                allowEditing:false
	            },
	            {
	                dataField: "namafasyankes",
	                caption: "Nama Fasyankes",
	                allowEditing:false
	            },
	            {
	                dataField: "namapetugas",
	                caption: "Nama Petugas",
	                allowEditing:false
	            },
	            {
	                dataField: "namapeminjam",
